...
export default class settingHelpScreen extends React.Component {
                    ...
                    <View style={styles.contentContainer}>
                        <View style={styles.emailContainer}>
                            <View style={styles.emailIcon}>
                                <MaterialCommunityIcons name="email" size={this.iconSize()} color="#EEB067" />
                            </View>
                            <View style={styles.emailTextContainer}>
                                <Text style={styles.emailText}>brighterdayscontacts@gmail.com</Text>
                            </View>
                        </View>
                        <View style={styles.textContainer}>
                            <Text style={styles.textStyle}>Notice any bugs/issues, or have a question? Contact me here!</Text>
                        </View>
                    </View>
                </View>
            )
